...
source ~/work/cms-be/shell/mysql/diaodiao_article_tag_index.sql;
source ~/work/cms-be/shell/mysql/diaodiao_article_tag_name.sql;
source ~/work/cms-be/shell/mysql/diaodiao_author.sql;
source ~/work/cms-be/shell/mysql/diaodiao_cms_user.sql;
