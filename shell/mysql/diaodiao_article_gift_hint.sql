DROP TABLE IF EXISTS `diaodiao_article_gift_hint_v2`;
CREATE TABLE `diaodiao_article_gift_hint_v2` (
  `aid` INT(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '文章id',
  `used_for_gift` TINYINT(4) DEFAULT '0' COMMENT '是否适合送礼，0-不适合；1-适合',
